...
**Lo primero que deben saber es lo siguiente: la terminal funciona a través de comandos. La estructura básica de un comando es la siguiente:** 
...
Una parte importante de crear algo es tener la capacidad de poderlo borrar y para ello tenemos el comando *rm*:

    rm file1.txt 

Para eliminar un directorio con los elementos que estén en él, debemos hacerlo agregando una opción al comando anterior:
...
Deberás sustituir la palabra PID por el número identificador de proceso que te arroja el ordenador.

Finalmente, veremos los *loops/ciclos/bucles* que son una manera de optimizar nuestros procesos, son una declaración de iteración lo cual es realmente útil para tareas repetitivas. 
...
También existen ciclos condicionales *(if)*, es decir, que se realizan solo si se cumple con una condición y en caso de no hacerlo se realiza otra tarea. Por ejemplo: 
...
Este material fue tomado de [Bioinfo_Inmunologia2023](https://github.com/Cciliana/Bioinfo_Inmunologia2023)
